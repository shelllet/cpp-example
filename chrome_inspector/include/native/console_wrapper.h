...
namespace shelllet {
	namespace global {
		...
		public:
			...
			MyConsoleWrapper(v8::Isolate* isolate, const v8::Local<v8::FunctionTemplate>& tpl) : ObjectWrapper(isolate, tpl)
			{
				tpl->Set(isolate, "log", v8::FunctionTemplate::New(isolate, Print));
			}
			MyConsoleWrapper(v8::Isolate* isolate, const v8::Local<v8::ObjectTemplate>& proto) : ObjectWrapper(isolate, proto)
			{
			}
