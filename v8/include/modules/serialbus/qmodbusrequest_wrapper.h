...
namespace shelllet {
	namespace serialbus {
		template<typename T, bool> class QModbusRequestPrivate;
		template<typename T, typename U, bool C>
		class QModbusRequestWrapper : public QModbusPduWrapper<T, U, C>
		{
		public:

			template<bool M>
			QModbusRequestWrapper(QModbusRequestPrivate<T, M>& d, const v8::FunctionCallbackInfo<v8::Value>& args)
				: QModbusPduWrapper(d, args) {
			}
			QModbusRequestWrapper(v8::Isolate* isolate, const v8::Local<v8::FunctionTemplate>& tpl) : QModbusPduWrapper(isolate, tpl) {}
			QModbusRequestWrapper(v8::Isolate* isolate, const v8::Local<v8::ObjectTemplate>& proto) : QModbusPduWrapper(isolate, proto)
			{
